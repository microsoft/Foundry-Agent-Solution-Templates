...
This template does not have a fixed monthly price. As of **September 7, 2026**, a low-usage deployment of the default configuration is approximately **USD 82 per 730-hour month** at Azure public retail rates. This is a planning example, not a quote.
