...
- `hosted-agent/` — hosted-agent source, dependencies, and container definition
- `infra/apim.bicep` — APIM gateway infrastructure
- `infra/foundry.bicep` — Foundry guardrail policy and project RBAC
- `infra/*.parameters.json` — azd parameter mappings for both Bicep layers
