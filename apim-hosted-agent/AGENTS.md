...
- `infra/modules/apim-model.bicep` — direct and subscription-key model gateways, portal Product, and links
...
- `retired/` — archived examples that are not part of this hosted-agent deployment
