...
async def main():
    ...
    os.environ["TOOLBOX_ENDPOINT"] = required_env("AGENT_TOOLBOX_ENDPOINT")
    ...
    client = FoundryChatClient(
        project_endpoint=required_env("AGENT_APIM_PROJECT_ENDPOINT"),
        model=required_env("AGENT_MODEL_DEPLOYMENT"),
